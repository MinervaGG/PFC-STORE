...
public class ItemRestController {
    ...
    ResponseEntity<List<ItemDTO>> getAllItemsFromCategory(@PathVariable Long categoryId){
    ...
    ResponseEntity<?> deleteIemById(@PathVariable Long itemId){
    ...
    ResponseEntity<ItemDTO> getIemById(@PathVariable Long itemId){
